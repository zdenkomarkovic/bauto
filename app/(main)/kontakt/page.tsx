              ...
              <div className="space-y-2">
                {KONTAKT.prodaja.telefoni.map((tel) => (
                  <a
                    ...
                    className="flex items-center gap-2 text-sm text-gray-700 hover:text-yellow-500 transition-colors"
                  >
            ...
            <div className="bg-white rounded-xl border border-gray-200 p-6">
              ...
              <dl className="space-y-2 text-sm">
                ...
                <div className="flex justify-between">
                  ...
                  <dd className="font-semibold text-gray-900">{RADNO_VREME.subota}</dd>
                </div>
                <div className="flex justify-between">
                  <dt className="text-gray-500">Nedjelja</dt>
                  <dd className="font-semibold text-gray-900">{RADNO_VREME.nedjelja}</dd>
                </div>
              </dl>
            </div>
          </div>
