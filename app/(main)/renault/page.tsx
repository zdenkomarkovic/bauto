...
export const metadata = buildMetadata({
  title: "Renault – nova vozila",
  description: "Pogledajte ponudu novih Renault vozila u B AUTO salonu u Užicu.",
});

export default async function RenaultPage() {
  const vozila = await getVozila("renault");
  ...
  return (
    <div className="min-h-screen bg-gray-50">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        <h2 className="text-2xl font-bold text-gray-900 mb-8">Naša ponuda Renault vozila</h2>
        {vozila.length === 0 ? (
                  ...
                  {vozilo.pogon && (
                    <div className="flex flex-col items-start gap-1 mt-1">
                      {/full h[iy]brid/i.test(vozilo.pogon) && (
                        <span className="text-xs text-gray-400">Takođe kao</span>
                      )}
